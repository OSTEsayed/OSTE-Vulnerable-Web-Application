...
<body>
    ...
    <h1>OSTE Vulnerable Web Application List of Vulnerablities</h1>
    <div class="button-container">
        <button class="button" onclick="location.href='SQL/index.php';">SQL Injection</button>
        <button class="button" onclick="location.href='XSS/index.php';">Cross-site Scripting</button>
        <button class="button" onclick="location.href='OS/index.php';">OS Command Injection</button>
    </div>
